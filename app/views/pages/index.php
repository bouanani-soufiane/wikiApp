...
?>
    ...
    <div class="font-sans mx-auto max-w-screen-lg text-black mt-5 bg-white flex items-center justify-between">
        <div class="border rounded overflow-hidden flex items-center justify-center w-full">
            <input type="text" class="px-4 w-full py-2" placeholder="Search..." id="search" >
    ...
    <div class="" id="content">
                    ...
                    <div class="rounded ">
                        <a href="<?php echo URLROOT; ?>/Wikis/showWikiCateg/<?php echo $categ->getId();?>">
                            <div class="relative h-full">
                                <img class="w-full" src="<?= URLROOT ?>/img/<?php echo ($categ->getImage()); ?>" alt="Sunset in the mountains">
        ...
        <div class="flex justify-center">
            <a href="<?php echo URLROOT;?>/categories/categories">
                <button class="bg-gray-800 hover:bg-blue-700 text-white font-bold py-2 px-4 border-b-4 border-blue-500 hover:border-blue-700 rounded">
                    Voir plus
                </button>
            </a>
        </div>
