                ...
                <?php foreach ($tags as $tag) : ?>
                    <tr>
                        ...
                        <td class=" flex py-2 px-4 border-b border-b-gray-50 w-1/5">
                            ...
                            <div class="my-2">
                                <button  data-tag-name="<?php echo $tag->getName();?>" data-tag-id="<?php echo $tag->getId();?>" id="editTag" data-modal-target="edit-modal-tag" data-modal-toggle="edit-modal-tag" class="mt-2 py-2 px-4 bg-green-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue active:bg-blue-800" type="button">
                                            ...
                                            <form class="p-4 md:p-5" method="post" action="<?php echo URLROOT?>/Tags/edit">
                                                <div class="grid gap-4 mb-4 grid-cols-2">
                                                    <div class="col-span-2">
                                                        ...
                                                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tag Name</label>
                                                        <input value="<?php echo $tag->getName();?>"  id="nameTag" type="text" name="tagName" id="name" class="bg-white text-gray-900 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:placeholder-gray-400  outline-0" placeholder="Name" >
                                                    </div>
                                                </div>
