                            ...
                            <form class="p-4 md:p-5" method="post" action="">
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" name="CategorieName" id="name" class="bg-white text-gray-900 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:placeholder-gray-400  outline-0" placeholder="tag name" required="">
                                    </div>
                                </div>
                    ...
                    <tr>
                        ...
                        <td class=" flex py-2 px-4 border-b border-b-gray-50 w-1/5">
                            <form method="post" class="mx-2">
                                <div class="my-2">
                                    <button value="" name="deleteLyrics" class="mt-2 py-2 px-4 bg-red-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
                            ...
                            <form method="post">
                                <div class="my-2">
                                    <button value="" name="approve" class="mt-2 py-2 px-4 bg-green-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
